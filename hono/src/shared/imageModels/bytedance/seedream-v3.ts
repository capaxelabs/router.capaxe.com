...
import { processSingleFile, postCalcSimple, processSingleOrMultipleFiles, postCalcNanoGPTDiscounted5 } from '../../../lib/imageHelpers'
...
export default class SeedreamV3 {
  ...
  async applyImageFal(params: any): Promise<any> {
